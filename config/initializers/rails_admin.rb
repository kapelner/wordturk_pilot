...
# RailsAdmin config file. Generated on September 27, 2011 00:13
...
RailsAdmin.config do |config|
  ...
  config.main_app_name { ['Wordturkers', 'Admin'] } # auto-generated
  ...
  # config.excluded_models << [BigBrotherParam, BigBrotherTrack, BrowserStatus, Disambiguation, RoundedCorner, SenseevalInventory, Snippet, VersionInfo, Word, WordnetDefinition]
  
  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [BigBrotherParam, BigBrotherTrack, BrowserStatus, Disambiguation, RoundedCorner, SenseevalInventory, Snippet, VersionInfo, Word, WordnetDefinition]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model BigBrotherParam do
  #   # Found associations: 

  #   field :big_brother_track, :belongs_to_association
  ...
  #   field :big_brother_track_id, :integer        # Hidden
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model BigBrotherTrack do
  #   # Found associations: 

  #   field :big_brother_params, :has_many_association

  #   # Found columns:

  #   field :id, :integer

  #   field :mturk_worker_id, :string
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model BrowserStatus do
  #   # Found associations: 

  #   field :disambiguation, :belongs_to_association

  #   # Found columns:

  #   field :id, :integer

  #   field :disambiguation_id, :integer        # Hidden
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model Disambiguation do
  #   # Found associations: 

  #   field :snippet, :belongs_to_association

  #   field :wordnet_definition, :belongs_to_association

  #   field :browser_statuses, :has_many_association

  #   # Found columns:

  #   field :id, :integer

  #   field :snippet_id, :integer        # Hidden

  #   field :wordnet_definition_id, :integer        # Hidden

  #   field :mturk_hit_id, :string

  #   field :mturk_group_id, :string
  ...
  #   field :to_be_expired_at, :datetime

  #   field :treatment, :integer

  #   field :mturk_assignment_id, :string
  ...
  #   field :read_consent_at, :datetime

  #   field :age, :integer

  #   field :gender, :string

  #   field :read_directions_at, :datetime

  #   field :finished_at, :datetime

  #   field :browser_info, :text
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model SenseevalInventory do
  #   # Found associations: 
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :word, :belongs_to_association
  ...
  #   field :word_id, :integer        # Hidden

  #   field :correct_wordnet_definition_id, :integer        # Hidden

  #   field :news_article_id, :integer
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :snippets, :has_many_association

  #   field :wordnet_definitions, :has_many_association
  ...
  #   field :sense_inventory_filename, :string
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model WordnetDefinition do
  #   # Found associations: 
  ...
  #   field :disambiguations, :has_many_association
